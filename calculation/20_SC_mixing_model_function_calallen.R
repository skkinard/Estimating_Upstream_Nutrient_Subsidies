...
# uses all sites in region

run_simmr_calallen <- function(my_data, my_group) {
  ...
  # Preview input data
  plot(simmr_in) + ggtitle(paste('Preview', sep='-'))
  ...
  # density plot
  plot(simmr_out, type = 'density') + ggtitle('Source Density')
